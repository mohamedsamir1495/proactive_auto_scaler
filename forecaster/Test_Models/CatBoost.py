...
class CatBoost(TestModel):

    def __init__(self, input_chunk_length=14, output_chunk_length=1, n_epochs=100, random_state=0):
        super().__init__(
            "CatBoost_with_inputChunkLength_{}_outputChunkLength_{}_nEpochs_{}_randomState_{}"
    ...
    def get_prediction(self, train, test, column_name):
        ...
        predictions = self.model.predict(n=len(test_copy), series=TimeSeries.from_series(new_test[column_name]),
